...
def update_executive_summary_hybrid():
    doc = Document()
    ...
    summary_text = [
        ...
        "1. Hybrid AI/ML Pricing Engine: The system uniquely blends pre-trained Machine Learning (ML) models with Large Language Models (LLMs). While trained ML models provide a statistical baseline from historical datasets, the LLM-driven pricing service performs real-time market grounding by scraping platforms like GSMArena and local Pakistani marketplaces. This hybrid approach ensures price suggestions are both statistically sound and reactive to current market volatility.",
    ...
    print("EZSell_Executive_Summary.docx updated with Hybrid AI/ML details.")

if __name__ == "__main__":
    update_executive_summary_hybrid()
